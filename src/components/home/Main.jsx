 ...
 const toggle=()=>{
  ...
  return (
    <>
      ...
      <div className="bg-cianF5 h-6 w-6 rounded-full shadow flex items-center justify-center -ml-2">
          </div>
...
<div className="flex justify-center mt-5 ">
  <div className="flex flex-col justify-between bg-white p-2 rounded-2xl w-400 h-96 mb-4">
    <div className='flex justify-center mt-5 text-moradoFuerteF5'>
  ...
  {state ? 'Registrar salida' : 'Registrar entrada'}
      ...
      <div className="flex justify-center max-w-[300 px] mb-4">
        <div className="flex-col justify-between bg-violet-300 p-6 rounded-2xl ">
          ...
          <div className="flex mt-10 grid-4 gap-2">
            <div className="bg-naranjaF5 w-14 h-14 rounded-full "> </div>
            {showSalida ? (
              <h2 className="flex self-center text-1xl text-black font-bold ">
                {" "}
                {hour}:{minutes}
