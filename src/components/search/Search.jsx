    ...
    <>
      <div className="flex justify-center grid-cols-2 mx-6">
        <input
          ...
          type="search"
          id="default-search"
          className="w-60 h-6 flex justify-center items-center bg-grisF5 p-5 m-2 rounded-md border-2 text-moradoFuerteF5"
          fill=" moradoFuerteF5 "
          required
        ></input>
          ...
          <div class="mx-5 my-2 grid-cols-5 grid-row-2 rounded-lg border-2 border-b-4 border-l-4 bg-white border-moradoFuerteF5/20 px-4 shadow-xl">
            <div class="flex h-16 items-center justify-between">
              <a href="http://localhost:3000/profile">
                <img alt="photo" class="w-10 rounded-full" src={user.image} />
              </a>
              <div class="ml-2">
                <div class="text-xs flex font-semibold text-moradoFuerteF5 w-40">
