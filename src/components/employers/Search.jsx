...
import face from '../../assets/img/searchimg/face.jpg'
...
const Search = () => {
  ...
  return (
    ...
    <table>
    <div className="my-2 flex h-16 items-center justify-between rounded-lg border-2 border-b-4 border-l-4 border-moradoFuerteF5 px-4 shadow-xl">
